...
import styles from "./WorkWear.module.scss";
        ...
        {data
          .filter(function (card) {
            switch (selectedCategory) {
              case "Рабочая":
                return card.category === "Рабочая";
              case "Влагозащитная":
                return card.category === "Влагозащитная";
              case "От повышенных температур":
                return card.category === "От повышенных температур";
              case "Для сферы услуг":
                return card.category === "Для сферы услуг";
              case "Трикотаж и головные уборы":
                return card.category === "Трикотаж и головные уборы";
              default:
                return card;
            }
          })
